package br.mp.mpro.protocolom3.repository;

import br.mp.mpro.protocolom3.ProtocoloM3App;
import br.mp.mpro.protocolom3.config.Constants;
import br.mp.mpro.protocolom3.config.audit.AuditEventConverter;
import br.mp.mpro.protocolom3.domain.PersistentAuditEvent;
...
import static br.mp.mpro.protocolom3.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
